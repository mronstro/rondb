 ...
 *                        the stop command (e.g. stopping the mgm server
 *                        that handle is connected to)
 * @param   extended_timeout Extend timeout from 5 min to 1 hour
 *
 * @return                Number of nodes stopped (-1 on error).
 */
int ndb_mgm_stop5(NdbMgmHandle handle, int no_of_nodes, const int *node_list,
                  int abort, int force, int *disconnect, int extended_timeout);
 ...
 * @return                Number of nodes stopped (-1 on error).
 */
int ndb_mgm_restart5(NdbMgmHandle handle, int no_of_nodes, const int *node_list,
                     int initial, int nostart, int abort, int force,
