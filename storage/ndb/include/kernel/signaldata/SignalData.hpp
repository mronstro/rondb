...
GSN_PRINT_SIGNATURE(printNDB_STTOR);
GSN_PRINT_SIGNATURE(printNDB_STTORRY);
GSN_PRINT_SIGNATURE(printTCROLLBACKREP);
GSN_PRINT_SIGNATURE(printGCPSaveReq);
GSN_PRINT_SIGNATURE(printGCPSaveRef);
GSN_PRINT_SIGNATURE(printGCPSaveConf);
// GSN_PRINT_SIGNATURE(printREDO_STATE_REP);
// GSN_PRINT_SIGNATURE(printDIH_SWITCH_REPLICA_REQ);
