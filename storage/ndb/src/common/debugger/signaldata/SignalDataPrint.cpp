...
SignalDataPrintFunctions[] = {
  ...
  ,{ GSN_DIADDTABREQ, printDIADDTABREQ }
  ,{ GSN_DIADDTABREF, printDIADDTABREF }
  ,{ GSN_DIADDTABCONF, printDIADDTABCONF }

  ,{ GSN_DATABASE_QUOTA_REP, printDATABASE_QUOTA_REP }
  ,{ GSN_DATABASE_RATE_ORD, printDATABASE_RATE_ORD }
  ,{ GSN_RATE_OVERLOAD_REP, printRATE_OVERLOAD_REP }
  ,{ GSN_QUOTA_OVERLOAD_REP, printQUOTA_OVERLOAD_REP }

  ,{ GSN_GET_DATABASE_REQ, printGET_DATABASE_REQ }
  ,{ GSN_GET_DATABASE_CONF, printGET_DATABASE_CONF }
  ,{ GSN_GET_DATABASE_REF, printGET_DATABASE_REF }

  ,{ GSN_LIST_DATABASE_REQ, printLIST_DATABASE_REQ }
  ,{ GSN_LIST_DATABASE_CONF, printLIST_DATABASE_CONF }
  ,{ GSN_LIST_DATABASE_REF, printLIST_DATABASE_REF }

  ,{ GSN_NDB_STTOR, printNDB_STTOR }
  ,{ GSN_NDB_STTORRY, printNDB_STTORRY }
  ,{ GSN_TCROLLBACKREP, printTCROLLBACKREP }
  ,{ GSN_GCP_SAVEREQ, printGCPSaveReq }
  ,{ GSN_GCP_SAVEREF, printGCPSaveRef }
  ,{ GSN_GCP_SAVECONF, printGCPSaveConf }
  // ,{ GSN_REDO_STATE_REP, printREDO_STATE_REP }
  // ,{ GSN_DIH_SWITCH_REPLICA_REQ, printDIH_SWITCH_REPLICA_REQ }
