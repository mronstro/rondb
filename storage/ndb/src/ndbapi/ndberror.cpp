...
ErrorBundle ErrorCodes[] = {
  ...
  { 888,  DMEC, AE, "Trying to write from interpreter but not an UPDATE operation" },
  { 890,  DMEC, AE, "Call error in interpreter" },
  { 891,  DMEC, AE, "SHIFT operand error in interpreter" },
  { 892,  DMEC, AE, "Unsupported branch type" },
  { 927,  DMEC, AE, "Flag set to not use disk columns, but still done" },
  ...
  { 4563, DMEC, AE, "Bad in/output index, only index 0-15 exists" },
  ...
  { 4574, DMEC, AE, "Key value out of range for range-partitioned table" },
